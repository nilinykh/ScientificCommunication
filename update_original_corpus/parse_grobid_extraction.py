"""
Last edit: 2025-01-28
Adapted from original code:
https://github.com/shauryr/ACL-anthology-corpus/blob/main/code/parse_grobid_extraction/main.py
...
def get_dataframe(path_to_extraction_folder, parquet_path, k=None):
    #list_files = glob.glob(path_to_extraction_folder + "*.tei.xml")
    list_files = glob.glob(os.path.join(path_to_extraction_folder, "*.tei.xml"))
    #list_files = os.listdir(path_to_extraction_folder)
    #list_files = [f for f in list_files if f.endswith('.tei.xml')]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "path_to_dataframe_file",
        type=str,
        default="",
        help="parquet file where to write processed dataframe",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="number of dataframe entries to retain",
    )
